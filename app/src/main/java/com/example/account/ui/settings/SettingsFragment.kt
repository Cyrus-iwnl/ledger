...
class SettingsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.dataTransferItem.setOnClickListener {
            openDataTransferSettings()
        }
    ...
    private fun openDataTransferSettings() {
        parentFragmentManager.beginTransaction()
            .replace(
                R.id.fragment_container,
                DataTransferFragment.newInstance(),
                DataTransferFragment::class.java.name
            )
            .addToBackStack(DataTransferFragment::class.java.name)
            .commit()
    }
